...
return [
    ...
    'home' => [
        ...
        'certifications_tag'     => 'Qualidade & Conformidade',
        'certifications_title'   => 'Certificações',
        'certifications_see_all' => 'Ver todas as certificações',
        'cert_valid'             => 'Válido',
        'cert_expired'           => 'Expirado',
        'cert_issuer'            => 'Emissor',
        'cert_number'            => 'Número',
        'cert_issued_at'         => 'Emitido em',
        'cert_expires_at'        => 'Validade',
        'cert_description'       => 'Descrição',
        'cert_document'          => 'Documento',
        'cert_view_pdf'          => 'Ver Certificado (PDF)',
        'cert_expired_label'     => '(Expirado)',
