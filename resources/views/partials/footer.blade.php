                ...
                <div class="flex items-center gap-3">
                    ...
                    @if($social->linkedin_url)
                        <a href="{{ $social->linkedin_url }}" target="_blank" rel="noopener noreferrer"
                           class="w-8 h-8 rounded-full bg-white/5 border border-white/10 hover:bg-[#0A66C2]/20 hover:border-[#0A66C2]/40 flex items-center justify-center transition-all"
                           title="LinkedIn">
                            <svg class="w-3.5 h-3.5 text-blue-400 hover:text-[#0A66C2] transition-colors" fill="currentColor" viewBox="0 0 24 24">
