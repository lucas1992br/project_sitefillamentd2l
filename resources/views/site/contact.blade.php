                    ...
                    <div class="flex gap-3">
                        ...
                        @if($siteContent->linkedin_url)
                            <a href="{{ $siteContent->linkedin_url }}" target="_blank" rel="noopener noreferrer"
                               class="w-10 h-10 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/30 flex items-center justify-center transition-all">
